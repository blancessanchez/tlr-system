 ...
 * @method \App\Model\Entity\LeaveBalance newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\LeaveBalance[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\LeaveBalance|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\LeaveBalance[] patchEntities($entities, array $data, array $options = [])
