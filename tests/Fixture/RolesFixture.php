...
class RolesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'Admin, Principal, Teacher', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-21 15:29:00',
                'modified' => '2019-09-21 15:29:00',
                'deleted_date' => '2019-09-21 15:29:00',
                'deleted' => 1
            ],
        ];
        parent::init();
