...
class TermsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'academic_year' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-22 13:36:18',
                'modified' => '2019-09-22 13:36:18',
                'deleted_date' => '2019-09-22 13:36:18',
                'deleted' => 1
            ],
        ];
        parent::init();
