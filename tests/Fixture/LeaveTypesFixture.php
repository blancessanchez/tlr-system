...
class LeaveTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'days_applicable' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'days_applicable' => 1,
                'created' => '2019-09-21 15:28:52',
                'modified' => '2019-09-21 15:28:52',
                'deleted_date' => '2019-09-21 15:28:52',
                'deleted' => 1
            ],
        ];
        parent::init();
