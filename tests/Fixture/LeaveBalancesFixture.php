...
class LeaveBalancesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'leave_type_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '1. vacation, 2. sick', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'balance' => 1,
                'leave_type_id' => 1,
                'created' => '2019-09-21 15:28:37',
                'modified' => '2019-09-21 15:28:37',
                'deleted_date' => '2019-09-21 15:28:37',
                'deleted' => 1
            ],
        ];
        parent::init();
